...
export class IframeViewComponent implements OnInit {
  ...
  yt = '<iframe style="width: 100%; height: 500px; background-color: rgba(0,0,255,0.1);" src="https://roads-veloroute.hamburg/" frameborder="10" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
  editable = true;
